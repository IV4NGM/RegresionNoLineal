...
$$
X_{11}^0 = \left. \frac{x_1}{\theta_2 + x_1} \right|_{\theta_2 = 0.08} = \left. \frac{0.02}{0.08 + 0.02} \right|_{\theta_2 = 0.08} = 0.2,
$$
y también,
$$
X_{12}^0 = \left. \frac{-\theta_1 x_1}{\left(\theta_2 + x_1\right)^2} \right|_{\substack{\theta_1 = 205 \\ \theta_2 = 0.08}} = \left. \frac{(-205)(0.02)}{\left(0.08 + 0.02\right)^2} \right|_{\theta_2 = 0.08} = -410.
$$
...
$$
    \operatorname{Var}(\boldsymbol{\hat{\theta}})=\sigma^2 {\left(\hat{X}^\top \hat{X}\right)}^{-1},
$$ {#eq-Var-asintotica}
...
\begin{itemize}
  ...
  \item $H_S(\boldsymbol{\theta}_0)$ es el Hessiano de $S$ evaluado en $\boldsymbol{\theta}_0$.
\end{itemize}
...
donde:
\begin{itemize}
  \item $J_f(\boldsymbol{\theta})$ es el **jacobiano de $\boldsymbol{f}$ respecto a $\boldsymbol{\theta}$, y
  \item $H_{f_i}(\boldsymbol{\theta})$ es el **hessiano** de la componente $f_i$ respecto a $\boldsymbol{\theta}$.
\end{itemize}
...
plot(NA, xlim = c(0, 30), ylim = c(-2, 0),
